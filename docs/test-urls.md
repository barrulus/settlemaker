...
Builder (human landing page): https://settlemaker.netlify.app/
Image endpoint (URL contract): https://settlemaker.netlify.app/fmg

## Page behavior

| Check | URL | Expect |
|---|---|---|
| Builder page | https://settlemaker.netlify.app/ | Human landing page: form, live preview, copyable image links |
| Random demo | https://settlemaker.netlify.app/fmg | A different settlement per reload, filling the viewport |
| Broken payload | https://settlemaker.netlify.app/fmg?i=garbage | Parchment error card, reason `base64`/`inflate` — never a blank page |
| Unknown theme | https://settlemaker.netlify.app/fmg?name=X&pop=100&theme=nope | Error card listing the known theme presets |

## Flat parameter tier

| Check | URL |
|---|---|
| Coastal village, bearing-only water (organic synthetic shore) | https://settlemaker.netlify.app/fmg?name=Saltmere&pop=350&seed=3&port=1&plaza=1&oceanBearing=180&harbourSize=small |
| Walled town, classic theme | https://settlemaker.netlify.app/fmg?name=Aldford&pop=1400&seed=9&walls=1&plaza=1&temple=1&theme=classic |
| Same town, night theme | https://settlemaker.netlify.app/fmg?name=Aldford&pop=1400&seed=9&walls=1&plaza=1&temple=1&theme=night |
| Same town, ink theme | https://settlemaker.netlify.app/fmg?name=Aldford&pop=1400&seed=9&walls=1&plaza=1&temple=1&theme=ink |
...
| pop | URL |
|---|---|
| 20,000 | https://settlemaker.netlify.app/fmg?name=Aldford&pop=20000&seed=9&walls=1&plaza=1&temple=1&theme=ink |
| 30,000 | https://settlemaker.netlify.app/fmg?name=Aldford&pop=30000&seed=9&walls=1&plaza=1&temple=1&theme=ink |
| 70,000 | https://settlemaker.netlify.app/fmg?name=Aldford&pop=70000&seed=9&walls=1&plaza=1&temple=1&theme=ink |
| 200,000 | https://settlemaker.netlify.app/fmg?name=Aldford&pop=200000&seed=9&walls=1&plaza=1&temple=1&theme=ink |
